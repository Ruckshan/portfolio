...
class MyDocument extends next_document__WEBPACK_IMPORTED_MODULE_1___default.a {
  render() {
    return __jsx(next_document__WEBPACK_IMPORTED_MODULE_1__["Html"], {
      ...
      name: "author",
      content: "Dinesh Balaji Venkataraj"
    }), __jsx("meta", {
      ...
      name: "twitter:site",
      content: "@sidthesloth92"
    }), __jsx("script", {
      async: true,
      src: `https://www.googletagmanager.com/gtag/js?id=${_lib_ga__WEBPACK_IMPORTED_MODULE_2__[/* GA_TRACKING_ID */ "a"]}`
    }), __jsx("script", {
      dangerouslySetInnerHTML: {
        __html: `
                ...
                gtag('js', new Date());
                gtag('config', '${_lib_ga__WEBPACK_IMPORTED_MODULE_2__[/* GA_TRACKING_ID */ "a"]}', {
      ...
      className: 'font-sans text-base text-white bg-dark'
